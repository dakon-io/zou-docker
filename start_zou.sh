...
sed -i "s/GUNICORN_ACTIVE/$GUNICORN_ACTIVE/g" /etc/nginx/http.d/default.conf
sed -i "s/NGINX_ACTIVE/$NGINX_ACTIVE/g" /etc/nginx/http.d/default.conf
sed -i "s/GUNICORN_EVENT_ACTIVE/$GUNICORN_EVENT_ACTIVE/g" /etc/nginx/http.d/default.conf
sed -i "s/RQ_ACTIVE/$RQ_ACTIVE/g" /etc/nginx/http.d/default.conf
